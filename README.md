...
1. **Input Text**: Enter the text you want to classify in the large text box provided. You can type or paste your text here.

2. **Classify Button**: Click the "Classify" button to initiate the classification process. The system will then classify the provided text as either AI-generated or human-generated.

3. **Clear Button**: Use the "Clear" button to clear the text input box and reset the result label. This helps in preparing for new text input.

4. **Threshold Slider**: The slider allows you to adjust the threshold for classification. Moving the slider towards the "AI" label increases the sensitivity to AI-generated text, while moving it towards the "Human" label increases sensitivity to human-generated text.

5. **Reset Threshold Button**: Clicking the "Reset Threshold" button sets the threshold back to its default value (0.6).

6. **Threshold Display**: This label displays the current threshold value, which is adjustable via the slider.
...
6. Model Selection and Training:
   ...
   - In order to address concerns regarding AI-generated text, we establish a threshold of 60%. If the model predicts with a probability greater than 60% that a text was generated by AI, it will classify it as AI-generated; otherwise, it will classify it as human-generated. This thresholding approach aims to minimize the risk of falsely attributing AI-generated texts to humans, thereby ensuring fair and responsible use of the model.
    - Our GUI enables users to adjust this threshold using a slider, allowing for customization of the classification sensitivity according to their preferences.
